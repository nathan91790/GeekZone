                ...
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item dropdown"><a class="dropdown-toggle nav-link" aria-expanded="false"
                        ...
                        <div class="dropdown-menu"><a class="dropdown-item" href="Cuisine.html">Cuisine</a><a
                                ...
                                class="dropdown-item" href="USB.html">USB</a></div>
                    </li>
                </ul><a class="login" href="Connexion.html"
                    style="background: rgba(32,201,151,0);color: var(--bs-gray-100);font-size: 20px;padding: 10px;">Se
                    Connecter</a><span class="navbar-text actions"> <a class="btn btn-light action-button" role="button"
                        href="Inscription.html"
                        style="font-size: 20px;color: var(--bs-gray-100);background: var(--bs-green);margin: 15px;">S'inscrire</a></span>
        ...
        <div class="container">
            ...
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/t-shirt-coder.jpg" style="width: 283px;height: 283px;"><img
                            class="img-fluid" src="assets/img/t-shirt-coder-1.jpg"
                            style="width: 283px;height: 283px;"></a>
                    ...
                    <p class="description" style="font-size: 17px;"><br>Coder ? On y perd son latin.', 'Informations
                        produit :&nbsp; Tee-shirt noir 100% coton peigné pré-rétréci.<br><br></p><a class="action"
                        href="#"></a>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/t-shirt-les-jeux-video-ont-ruine-ma-vie.jpg"><img class="img-fluid"
                            src="assets/img/t-shirt-les-jeux-video-ont-ruine-ma-vie-1.jpg"></a>
                    ...
                    <p class="description" style="font-size: 17px;"><br>T-Shirt avec un bien beau slogan spécial gamer :
                        Les Jeux Vidéo ont ruiné ma vie : Il m'en reste deux <br><br>&nbsp;</p><a class="action"
                        href="#"></a>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/bonnet-barbe-1.jpg" style="width: 283px;"><img class="img-fluid"
                            src="assets/img/bonnet-barbe.jpg" style="width: 283px;"></a>
                    ...
                    <p style="font-size: 17px;"><br>Le bonnet barbe, l''assurance d''une pilosité chaque jour
                        renouvelée.<br>Un véritable rêve s''offre à vous avec ce bonnet barbe !<br><br></p><a
                        class="action" href="#"></a>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="#"></a><a class="action" href="#"></a></div>
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/t-shirt-detecteur-wifi-1.jpg" style="width: 283px;"><img class="img-fluid"
                            src="assets/img/t-shirt-detecteur-wifi-2.jpg" style="width: 283px;"></a>
