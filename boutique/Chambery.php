...
$produitStatement = $mysqlConnection->prepare('SELECT `id` , `rue` , `ville`, `telephone`, `horaires` FROM `boutique` WHERE `id` = "4"' );
...
?>
   ...
   <strong>Boutique de Chambery</strong><br/> </br>
   <img class="img-fluid" src="../assets/img/boutique_chambery.jpg" style="width: 400px; height: 325px; margin-top : 57px;"><br/> </br>
