...
$produitStatement = $mysqlConnection->prepare('SELECT `id` , `rue` , `ville`, `telephone`, `horaires` FROM `boutique` WHERE `id` = "6"' );
...
?>
   ...
   <strong>Boutique d'Annecy</strong><br/> </br>
   <img class="img-fluid" src="../assets/img/boutique_annecy.jpg" style="width: 400px; height: 325px; margin-top : 57px;"><br/> </br>
