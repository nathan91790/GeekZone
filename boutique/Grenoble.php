...
$produitStatement = $mysqlConnection->prepare('SELECT `id` , `rue` , `ville`, `telephone`, `horaires` FROM `boutique` WHERE `id` = "2"' );
...
?>
   ...
   <strong>Boutique de Grenoble</strong><br/> </br>
   <img class="img-fluid" src="../assets/img/boutique_grenoble.jpg" style="width: 400px; height: 325px; margin-top : 57px;"><br/> </br>
