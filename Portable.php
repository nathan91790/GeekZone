        ...
        <div class="container">
            ...
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/ventilo-pour-iphone.jpg" style="width: 283px;height: 283px;"><img
                            class="img-fluid" src="assets/img/ventilo-pour-iphone-1.jpg"
                ...
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/coque-iphone-4-decapsuleur-2.jpg"><img class="img-fluid"
                            src="assets/img/coque-iphone-4-decapsuleur.jpg"><img class="img-fluid"
                            src="assets/img/coque-iphone-4-decapsuleur-1.jpg"></a>
                    ...
                    <p class="description" style="font-size: 17px;"><br>Avec cette coque intelligente conçue avec un
                        décapsuleur, vous serez toujours prêt à ouvrir votre boisson préférée !<br><br></p><a
                        class="action" href="#"></a>
                </div>
                <div class="col-sm-6 col-md-4 item"><a href="#"></a><img class="img-fluid"
                        src="assets/img/manette-jeu-pour-ecran-tactile-istick.jpg"><img class="img-fluid"
                        src="assets/img/manette-jeu-pour-ecran-tactile-istick-1.jpg">
                    ...
                    <p style="font-size: 17px;"><br>Le stick qui transforme votre smartphone en console portable, Une
                        manette spécifiquement conçue pour les écrans tactiles.<br><br></p><a class="action"
                        href="#"></a>
                </div>
            </div>
        </div>
