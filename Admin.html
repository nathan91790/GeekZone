<!DOCTYPE html>
<html lang="fr" style="background: url(&quot;https://cdn.bootstrapstudio.io/placeholders/1400x800.png&quot;);
color: rgb(0, 0, 0);">
...
<body style="background: linear-gradient(black 0%, rgb(118,197,118) 8%, white);">
    ...
    <p class="text-center d-xl-flex justify-content-xl-center"
        style="font-size: 50px;text-align: center;font-style: italic;font-weight: bold;">Bienvenue dans l'espace
        Administrateur</p>
