...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "14"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/manette-jeu-pour-ecran-tactile-istick.jpg" style="width: 400px; height: 325px; margin-top : 57px;">
   <img class="img-fluid" src="../assets/img/manette-jeu-pour-ecran-tactile-istick-1.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
