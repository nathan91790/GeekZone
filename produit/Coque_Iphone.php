...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "13"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/coque-iphone-4-decapsuleur.jpg" style="width: 400px; height: 325px; margin-top : 57px;">
   <img class="img-fluid" src="../assets/img/coque-iphone-4-decapsuleur-1.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
