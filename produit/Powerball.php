...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "7"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/powerball.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
