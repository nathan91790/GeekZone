...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "6"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/stealth-switch.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
