...
<body style="background: linear-gradient(black 0%, rgb(118,197,118) 8%, white);">
  ...
  <nav class="navbar navbar-light navbar-expand-lg navigation-clean-button"
    ...
    <div class="container"><a class="navbar-brand" href="../index.php" style="font-size: 60px;">GeekZone</a><button
      ...
      <div class="collapse navbar-collapse" id="navcol-1"><a class="login" href="../Boutiques.php"
        ...
        <ul class="navbar-nav me-auto">
          ...
          class="navbar-text actions"> <a class="btn btn-light action-button" role="button" href="../Inscription.php"
            style="font-size: 20px;color: var(--bs-gray-100);
...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "15"' );
...
?>
    <p style = "font-size: 32px;">
      ...
      <img class="img-fluid" src="../assets/img/chauffe-tasse-biscuit-usb.jpg" style="width: 400px; height: 325px; margin-top : 57px;">
      <img class="img-fluid" src="../assets/img/chauffe-tasse-biscuit-usb-1.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
      <p style = "font-size: 26px;"> Le produit se nomme : <?php echo $produit['nom']; ?>, il est vendue pour <?php echo $produit['prix']; ?> euros
      !<br /></br>
