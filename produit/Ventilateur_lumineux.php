...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "17"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/ventilateur-lumineux-usb.jpg" style="width: 400px; height: 325px; margin-top : 57px;">
   <img class="img-fluid" src="../assets/img/ventilateur-lumineux-usb-1.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
