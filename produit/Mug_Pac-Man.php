...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "2"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/mug-pac-man-chaud-froid.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
