...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "4"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/prise-chargeur-usb-robinet-1.jpg" style="width: 400px; height: 325px; margin-top : 57px;">
   <img class="img-fluid" src="../assets/img/prise-chargeur-usb-robinet.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
