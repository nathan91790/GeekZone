...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "3"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/fridgebook-magnet-reseau-social-frigo (1).jpg" style="width: 400px; height: 325px; margin-top : 57px;">
   <img class="img-fluid" src="../assets/img/fridgebook-magnet-reseau-social-frigo.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
