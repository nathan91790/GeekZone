...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "10"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/t-shirt-coder.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
   <img class="img-fluid" src="../assets/img/t-shirt-coder-1.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
