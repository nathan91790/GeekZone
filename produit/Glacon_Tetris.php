...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "1"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/glacons-tetris (2).jpg" style="width: 400px; height: 325px; margin-top : 57px;">
   <img class="img-fluid" src="../assets/img/glacons-tetris(1).jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
