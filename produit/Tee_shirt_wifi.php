...
$produitStatement = $mysqlConnection->prepare('SELECT `nom` , `description` , `detail`, `prix` FROM `produit` WHERE `produit_id` = "9"' );
...
?>
   ...
   <img class="img-fluid" src="../assets/img/t-shirt-detecteur-wifi.jpg" style="width: 400px; height: 325px; margin-top : 57px;">
   <img class="img-fluid" src="../assets/img/t-shirt-detecteur-wifi-1.jpg" style="width: 400px; height: 325px; margin-top : 57px;"> <br />
  <p style = "font-size: 32px;"> Le produit se nomme : <?php echo $produit['nom']; ?>, il est vendue pour <?php echo $produit['prix']; ?> euros !<br/></br>
