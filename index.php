        ...
        <div class="container">
            ...
            <div class="row articles">
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/glacons-tetris%20(1).jpg" style="width: 283px;height: 283px;"></a>
                ...
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/powerball.jpg"></a>
                ...
                <div class="col-sm-6 col-md-4 item"><a href="#"><img class="img-fluid"
                            src="assets/img/bonnet-barbe-1.jpg" style="width: 283px;"></a>
                    ...
                    <p style="font-size: 17px;"><br>Le bonnet barbe, l''assurance d''une pilosité chaque jour
                        renouvelée.<br>Un véritable rêve s''offre à vous avec ce bonnet barbe !<br><br><br></p><a
                        class="action" href="#"></a>
                </div>
            </div>
        </div>
