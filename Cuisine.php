    ...
    <section class="article-list" style="color: rgb(49, 52, 55);">
        ...
        <div class="container">
            ...
            <div class="row articles">
                ...
                <div class="col-sm-6 col-md-4 item"><a href="produit/Glacon_tetris.php"><img class="img-fluid" src="assets/img/glacons-tetris(1).jpg" style="width: 283px;height: 283px" ;></a>
